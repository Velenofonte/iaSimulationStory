...
from app.episodes.notoriety import gap as notoriety_gap
...
class EpisodeDirector:
    ...
    def decide(
        ...
        *,
        ...
        # World pressures from unresolved layer-3 intents bias toward action.
        if getattr(state, "story", None) and state.story.pressures:
            pressure_boost = [1.0, 0.85, 1.15, 1.25, 1.2, 1.1, 1.05]
            weights = _mul(weights, pressure_boost)
